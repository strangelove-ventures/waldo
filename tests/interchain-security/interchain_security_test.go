...
import (
	...
	appConsumer "github.com/waldolove-ventures/waldo/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and waldo consumer chain
